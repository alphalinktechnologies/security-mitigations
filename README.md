...
```bash
curl -sSL [https://raw.githubusercontent.com/alink-tech/security-mitigations/main/copy_fail_mitigation.sh](https://raw.githubusercontent.com/alink-tech/security-mitigations/main/copy_fail_mitigation.sh) | sudo bash
